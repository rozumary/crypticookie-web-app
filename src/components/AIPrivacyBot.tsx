...
export const AIPrivacyBot: React.FC = () => {
  ...
  return (
    <div className="space-y-5 pb-8">
      ...
      <div className="bg-[#0F061F] border border-[#261445] rounded-3xl p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#1A0935] hover:bg-[#250B42] text-purple-200 border border-pink-500/30 text-xs font-semibold transition-colors cursor-pointer"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-4 space-y-4 flex flex-col">
          ...
          <div className="bg-[#0F061F] border border-[#261445] rounded-2xl p-5 space-y-3">
            ...
            <div className="space-y-2">
              <input
                ...
                className="w-full bg-[#130729] border border-[#29154A] rounded-xl px-3.5 py-2.5 text-xs text-purple-100 placeholder-purple-400/40 font-mono focus:outline-none focus:border-pink-500"
                onKeyDown={(e) => e.key === 'Enter' && handleAuditWebsite()}
              />
              <button
                onClick={handleAuditWebsite}
                disabled={isLoading || !auditDomain.trim()}
                className="w-full flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 disabled:opacity-50 text-white font-bold text-xs transition-all cursor-pointer shadow-md"
              >
          ...
          <div className="bg-[#0F061F] border border-[#261445] rounded-2xl p-5 space-y-3 flex-1 flex flex-col justify-between">
            <div className="flex items-center gap-2 text-white font-bold text-xs">
              ...
              {DEFAULT_SUGGESTIONS.map((item, idx) => {
                ...
                return (
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full text-left p-3 rounded-xl bg-[#130729] hover:bg-[#1C0A3B] border border-[#29154A] hover:border-pink-500/40 transition-all cursor-pointer group"
                  >
                    <div className="flex items-start gap-2.5">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-purple-300/70 line-clamp-2 mt-0.5 leading-normal">
                          {item.prompt}
                        </p>
                      </div>
                    </div>
        ...
        <div className="lg:col-span-8 flex flex-col rounded-2xl border border-[#261445] bg-[#0F061F] overflow-hidden h-[620px] max-h-[72vh] shadow-xl">
          {/* Chat Window Top Bar */}
          <div className="flex items-center justify-between border-b border-[#29154A] bg-[#14082B] px-5 py-3 shrink-0">
            <div className="flex items-center gap-2.5">
              <div className="h-8 w-8 rounded-xl bg-gradient-to-r from-pink-600 to-purple-600 text-white flex items-center justify-center shrink-0">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-mono font-semibold text-purple-300/70 hidden sm:inline">
                Encrypted Session
              </span>
          ...
          {/* Messages Stream */}
          <div className="flex-1 p-4 sm:p-5 space-y-3.5 overflow-y-auto bg-[#0A0414]">
            {messages.map((m) => {
