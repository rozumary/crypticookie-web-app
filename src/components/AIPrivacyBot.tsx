...
export const AIPrivacyBot: React.FC = () => {
  ...
  return (
    <div className="space-y-5 pb-8">
      ...
      <div className="bg-gradient-to-r from-[#2e124f]/90 via-[#250d42]/90 to-[#2e124f]/90 border border-purple-400/30 rounded-3xl p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-xl shadow-purple-950/20 backdrop-blur-md">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="flex items-center gap-1 px-3 py-0.5 rounded-full bg-[#371661] text-pink-300 border border-purple-400/40 text-[11px] font-mono font-bold">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#371661] hover:bg-[#471c7d] text-purple-200 hover:text-white border border-purple-400/40 text-xs font-semibold transition-colors cursor-pointer shadow-sm"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-4 space-y-4 flex flex-col">
          ...
          <div className="bg-gradient-to-b from-[#2a104a]/90 to-[#220c3d]/90 border border-purple-400/30 rounded-2xl p-5 space-y-3 shadow-xl shadow-purple-950/20 backdrop-blur-md">
            ...
            <div className="space-y-2">
              <input
                ...
                className="w-full bg-[#1e0a36] border border-purple-400/35 rounded-xl px-3.5 py-2.5 text-xs text-purple-100 placeholder-purple-300/40 font-mono focus:outline-none focus:border-pink-500 focus:bg-[#250d42]"
                onKeyDown={(e) => e.key === 'Enter' && handleAuditWebsite()}
              />
              <button
                onClick={handleAuditWebsite}
                disabled={isLoading || !auditDomain.trim()}
                className="w-full flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 disabled:opacity-50 text-white font-bold text-xs transition-all cursor-pointer shadow-md shadow-pink-900/20"
              >
          ...
          <div className="bg-gradient-to-b from-[#2a104a]/90 to-[#220c3d]/90 border border-purple-400/30 rounded-2xl p-5 space-y-3 flex-1 flex flex-col justify-between shadow-xl shadow-purple-950/20 backdrop-blur-md">
            <div className="flex items-center gap-2 text-white font-bold text-xs">
              <HelpCircle className="h-4 w-4 text-pink-400" />
              <span>Quick Privacy Topics</span>
            </div>
            <div className="space-y-2">
              {DEFAULT_SUGGESTIONS.map((item, idx) => {
                ...
                return (
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full text-left p-3 rounded-xl bg-[#1e0a36] hover:bg-[#341459] border border-purple-400/30 hover:border-pink-500/40 transition-all cursor-pointer group"
                  >
                    <div className="flex items-start gap-2.5">
                      <Icon className="h-4 w-4 text-pink-400 mt-0.5 shrink-0 group-hover:scale-110 transition-transform" />
                      <div>
                        <div className="text-[11px] font-bold text-white group-hover:text-pink-300 transition-colors">
                          {item.title}
                        </div>
                        <p className="text-[10px] text-purple-200/80 line-clamp-2 mt-0.5 leading-normal">
                          {item.prompt}
                        </p>
                      </div>
                    </div>
        ...
        <div className="lg:col-span-8 flex flex-col rounded-2xl border border-purple-400/30 bg-gradient-to-b from-[#2a104a]/90 to-[#200b3b]/90 overflow-hidden h-[620px] max-h-[72vh] shadow-xl shadow-purple-950/25 backdrop-blur-md">
          {/* Chat Window Top Bar */}
          <div className="flex items-center justify-between border-b border-purple-400/30 bg-[#311357]/80 px-5 py-3 shrink-0">
            <div className="flex items-center gap-2.5">
              <div className="h-8 w-8 rounded-xl bg-gradient-to-r from-pink-600 to-purple-600 text-white flex items-center justify-center shrink-0 shadow-sm">
                <Bot className="h-4 w-4" />
              </div>
              <div>
                <h3 className="text-xs sm:text-sm font-bold text-white">Crypticookie Intelligence Engine</h3>
            ...
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-mono font-semibold text-purple-200/80 hidden sm:inline">
                Encrypted Session
              </span>
          ...
          {/* Messages Stream */}
          <div className="flex-1 p-4 sm:p-5 space-y-3.5 overflow-y-auto bg-[#18072c]/90">
            {messages.map((m) => {
              ...
              return (
                ...
                >
                  {isBot && (
                    <div className="h-8 w-8 rounded-xl bg-[#371661] border border-purple-400/40 flex items-center justify-center text-pink-300 shrink-0 mt-0.5 shadow-sm">
                      <Bot className="h-4 w-4" />
                    </div>
                  )}
                  ...
                  <div
                    className={`relative max-w-[85%] sm:max-w-[75%] rounded-2xl p-4 text-xs leading-relaxed ${
                      isBot
                        ? 'bg-gradient-to-br from-[#2f1352] to-[#240d42] border border-purple-400/35 text-purple-100 shadow-md'
                  ...
                  >
                    ...
                    <div className={`flex items-center justify-between gap-4 mt-2.5 pt-2 border-t text-[10px] font-mono ${
                      isBot ? 'border-purple-400/25 text-purple-300' : 'border-white/20 text-purple-100'
                    }`}>
            ...
            {messages.length <= 1 && (
              <div className="mt-3 pt-3 border-t border-purple-400/25 space-y-2.5">
                <div className="text-[11px] font-bold text-purple-200/90 flex items-center gap-1.5">
                  ...
                  {DEFAULT_SUGGESTIONS.map((s, idx) => {
                    ...
                    return (
                      <button
                        ...
                        disabled={isLoading}
                        className="text-left p-3 rounded-xl bg-[#230d3f] hover:bg-[#341459] border border-purple-400/30 hover:border-pink-500/40 transition-all cursor-pointer group flex items-start gap-2.5"
                      >
                        <div className="h-7 w-7 rounded-lg bg-[#371661] border border-purple-400/40 flex items-center justify-center shrink-0 text-pink-400 group-hover:scale-105 transition-transform">
            ...
            {isLoading && (
              <div className="flex items-start gap-3 justify-start animate-pulse">
                <div className="h-8 w-8 rounded-xl bg-[#371661] border border-purple-400/40 flex items-center justify-center text-pink-300 shrink-0">
                  <Bot className="h-4 w-4 animate-spin text-pink-400" />
                </div>
                <div className="rounded-2xl bg-gradient-to-br from-[#2f1352] to-[#240d42] border border-purple-400/35 p-4 text-xs text-purple-200 font-bold flex items-center gap-2">
          ...
          <div className="border-t border-purple-400/30 bg-[#311357]/80 p-4">
            <form
              onSubmit={(e) => {
                e.preventDefault();
                handleSendMessage();
            ...
            >
              <input
                ...
                className="flex-1 bg-[#1e0a36] border border-purple-400/35 rounded-xl px-4 py-2.5 text-xs text-purple-100 placeholder-purple-300/40 focus:outline-none focus:border-pink-500 focus:bg-[#250d42]"
              />
              <button
                type="submit"
                disabled={isLoading || !inputMessage.trim()}
                className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 disabled:opacity-50 text-white text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer hover:scale-105 active:scale-95 shadow-md shadow-pink-900/20"
              >
                <span>Send</span>
