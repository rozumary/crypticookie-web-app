  ...
  return (
    <div className="w-full space-y-8 pb-12">
      ...
      <div className="bg-gradient-to-r from-[#2e124f]/90 via-[#250d42]/90 to-[#2e124f]/90 border border-purple-400/30 rounded-3xl p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-xl shadow-purple-950/20 backdrop-blur-md">
        ...
        {savedSuccess && (
          <div className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-emerald-950/80 text-emerald-300 border border-emerald-500/40 text-xs font-bold animate-fadeIn shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-gradient-to-b from-[#2a104a]/90 to-[#200b3b]/90 border border-purple-400/30 rounded-3xl p-6 space-y-4 shadow-xl shadow-purple-950/20 backdrop-blur-md">
            ...
            <div className="space-y-3">
              {/* Setting Item 1 */}
              <div className="flex items-center justify-between p-4 rounded-2xl bg-[#1e0a36] border border-purple-400/30 shadow-sm">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="w-11 h-6 bg-[#371661] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-pink-600"></div>
                </label>
              </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-b from-[#2a104a]/90 to-[#200b3b]/90 border border-purple-400/30 rounded-3xl p-6 space-y-3.5 shadow-xl shadow-purple-950/20 backdrop-blur-md">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white font-bold text-xs transition-all cursor-pointer shadow-md shadow-pink-500/20"
            >
              {isExporting ? (
          ...
          <div className="bg-gradient-to-b from-[#2a104a]/90 to-[#200b3b]/90 border border-purple-400/30 rounded-3xl p-6 space-y-3.5 shadow-xl shadow-purple-950/20 backdrop-blur-md">
            ...
            <button
              ...
              disabled={isPurging}
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-rose-950/70 hover:bg-rose-900/80 border border-rose-700/50 text-rose-200 font-bold text-xs transition-colors cursor-pointer shadow-sm"
            >
          ...
          <div className="bg-gradient-to-b from-[#2a104a]/90 to-[#200b3b]/90 border border-purple-400/30 rounded-3xl p-5 text-center shadow-xl shadow-purple-950/20 backdrop-blur-md">
            <button
